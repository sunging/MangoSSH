...
internal object MangoUiLiteralLocalization {
    ...
    private val english = mapOf(
        ...
        "文件" to "Files",
        "浏览远端文件" to "Browse remote files",
        "已连接的会话" to "Connected sessions",
        "主机配置" to "Host profiles",
        "将为文件传输单独建立连接，无需先打开终端。" to
            "A separate connection is opened for file transfer, so no terminal is needed first.",
        "正在连接…" to "Connecting…",
        ...
        "此文件不是文本，无法预览。可以直接下载。" to
            "This file is not text and cannot be previewed. You can download it instead.",
        "仅预览文件开头部分。" to "Only the beginning of this file is previewed.",
        "完整大小" to "Full size",
        "排队中" to "Queued",
        "传输中" to "Transferring",
        "已完成" to "Completed",
