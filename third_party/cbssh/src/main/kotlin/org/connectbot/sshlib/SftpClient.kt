...
interface SftpClient : AutoCloseable {
    ...
    /** Server-declared extensions; values are never inferred from the server banner. */
    val extensions: Map<String, String>

    /** Atomically replaces a destination only with the OpenSSH version-1 extension. */
    suspend fun posixRename(oldPath: String, newPath: String): SftpResult<Unit>
