...
object SshKeys {
    ...
    /** Inspect encryption without decrypting or rewriting stored key material. */
    fun isEncrypted(pem: String): Boolean = PrivateKeyReader.isEncrypted(pem)

    /** Generate Ed25519 on Android without registering a global security provider. */
    fun generateEd25519KeyPair(): KeyPair =
        org.connectbot.sshlib.crypto.ed25519.Ed25519KeyPairGenerator().generateKeyPair()
