...
WORK_DIR="/tmp/mangossh-tsnetbridge-test-v1.102.2"
WORK_LOCK="/tmp/mangossh-tsnetbridge-test-v1.102.2.lock"
...
case "$WORK_DIR" in
    /tmp/mangossh-tsnetbridge-test-v1.102.2) ;;
...
case "$TAILSCALE_MODULE_DIR" in
    "$GO_MODULE_CACHE_ROOT"/tailscale.com@v1.102.2) ;;
