...
WORK_DIR="/tmp/mangossh-tsnetbridge-test-v1.102.4"
WORK_LOCK="/tmp/mangossh-tsnetbridge-test-v1.102.4.lock"
...
case "$WORK_DIR" in
    /tmp/mangossh-tsnetbridge-test-v1.102.4) ;;
...
case "$TAILSCALE_MODULE_DIR" in
    "$GO_MODULE_CACHE_ROOT"/tailscale.com@v1.102.4) ;;
